#!/bin/bash
#put script in cherish source folder, make executable (chmod +x createupdate.sh) and run it (./createupdate.sh)
...
zip="cherish zip"
buildtype="type" #choose from Unoffical/Official
...
paypal="https://paypal.me/hungphan2001" 
  ...
  "response": [
    {
        ...
        "device": "'$devicename'",
        "filename": "'$zip_only'",
        "download": "https://sourceforge.net/projects/cherish-os/files/device/'$device'/'$v_max'.x/'$zip_only'/download",
        "timestamp": '$timestamp',
        "md5": "'$md5'",
        "size": '$size',
        "version": "'$version'",
